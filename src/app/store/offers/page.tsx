...
import { Plus, Edit, Trash2, Eye, RefreshCw, MapPin } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Store Offers</h1>
            ...
            <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div>
                    <Label htmlFor="targetUsers">Target Customers</Label>
                    <Select
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="ALL_USERS">All Customers</SelectItem>
                        <SelectItem value="NEW_USERS">New Customers</SelectItem>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="isLocationBased"
                      checked={newOffer.isLocationBased}
                      onCheckedChange={(checked) =>
                        setNewOffer({
                          ...newOffer,
                          isLocationBased: Boolean(checked),
                        })
                      }
                    />
                    <Label
                      htmlFor="isLocationBased"
                      className="flex items-center gap-2"
                    >
                      <MapPin className="h-4 w-4" />
                      Location-based offer (valid only in service area)
                    </Label>
                  </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Your Store Offers ({offers.length})</CardTitle>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
