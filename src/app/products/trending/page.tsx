        ...
        <div className="w-full px-4">
          <div className="text-center">
            ...
            <p className="text-xl text-white/90 max-w-2xl mx-auto mb-8">
              Discover what's hot right now! These are the most popular products
              loved by our customers this week
            </p>
            ...
            <div className="flex justify-center gap-8 mb-8">
              ...
              <div className="text-center">
                ...
                <div className="text-white/80">Sales This Week</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold">
                  {Math.round(
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600">
                Updated daily based on customer purchases and ratings
              </p>
            </div>
        ...
        <div className="w-full">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Our trending products are determined by real customer behavior,
              ratings, and purchase patterns
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center p-6 border-0 shadow-lg">
              ...
              <p className="text-gray-600">
                Products with consistently high customer ratings and positive
                reviews
              </p>
            </Card>
            ...
            <Card className="text-center p-6 border-0 shadow-lg">
              ...
              <h3 className="text-xl font-semibold mb-3">Popular Choice</h3>
              <p className="text-gray-600">
                Items that are frequently purchased and recommended by customers
              </p>
            </Card>
            ...
            <Card className="text-center p-6 border-0 shadow-lg">
              ...
              <h3 className="text-xl font-semibold mb-3">Rising Demand</h3>
              <p className="text-gray-600">
                Products showing significant increase in popularity and sales
              </p>
            </Card>
          </div>
        </div>
