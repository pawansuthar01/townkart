export interface Store {
  ...
  // Store Management
  managerId: string | null; // Store manager user ID
  manager?: any; // User

  // Operating Hours (JSON)
  operatingHours: any; // {monday: {open: "09:00", close: "21:00"}, ...}
...
// Keep Shop interface for backward compatibility (maps to Store)
export interface Shop extends Store {
...
export interface CreateShopRequest extends CreateStoreRequest {
...
export type ElectronicsSubcategory =
  keyof typeof SHOP_SUBCATEGORIES.ELECTRONICS;
